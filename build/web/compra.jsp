...
<head>
    ...
    <script src="JS/scriptcompra.js"></script> <!-- Si tienes JS específico para compras -->
</head>
<body>
...
<!-- CONTENIDO PRINCIPAL -->
<main>
    <h1 class="mb-4">FORMULARIO COMPRAS</h1>
    ...
    <!-- Botón Nueva Compra -->
    <form action="compracontrolador" method="POST" class="mb-3">
    ...
    <%
        ...
        List<compramodelo> lista = c.listar();
    %>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                <% for (compramodelo compra : lista) { %>
                    <tr>
                        <td><%= compra.getId() %></td>
                        <td><%= compra.getFecha() %></td>
                        <td><%= compra.getCondicion() %></td>
                        <td><%= compra.getEstado() %></td>
                        <td><%= compra.getProveedor() %></td>
