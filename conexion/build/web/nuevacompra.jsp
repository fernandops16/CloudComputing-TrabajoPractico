...
<%@page import="java.util.*, modelo.compramodelo" %>
...
<%
    ...
    List<String[]> listaProveedores = c.listarProveedores();
    List<String[]> listaProductos = c.listarProductos();
%>
...
<main>
    ...
    <div class="mb-3">
        ...
        <div class="d-flex">
            <input type="text" id="nombreProveedor" class="form-control me-2" readonly>
            <button class="btn btn-primary" type="button" onclick="abrirModalProveedor()">Buscar Proveedor</button>
        </div>
    </div>
    ...
    <div class="col-md-3"><label>Nombre:</label><input type="text" id="nombreProducto" class="form-control" readonly></div>
    <div class="col-md-2"><label>Precio:</label><input type="text" id="precioProducto" class="form-control"></div>
    ...
    <div class="col-md-3 d-flex align-items-end">
        <button type="button" class="btn btn-secondary w-100" onclick="abrirModalProducto()">Buscar Producto</button>
    </div>
</div>
    ...
    <!-- FORMULARIO FINAL -->
    <form action="compracontrolador" method="POST" onsubmit="return prepararCompra()">
        ...
        <button type="submit" name="accion" value="guardarcompra" class="btn btn-success w-100 mt-3">GUARDAR COMPRA</button>
    </form>
</main>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td><%= prov[1] %></td>
                    <td><%= prov[2] %></td>
                    <td><button type="button" onclick='seleccionarProveedor("<%= prov[0] %>", "<%= prov[1] %>")'>Seleccionar</button></td>
                </tr>
                <% } %>
            </tbody>
        </table>
