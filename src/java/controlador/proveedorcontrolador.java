...
public class proveedorcontrolador extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(accion.equals("guardar")){
            ...
            p1.setRuc(request.getParameter("txtruc"));
            p1.setTelefono(request.getParameter("txttelefono"));
            p1.setCorreo(request.getParameter("txtcorreo"));
            p1.guardar();
    ...
    response.sendRedirect("rpt/rptproveedores.jsp"); // O como se llame tu reporte Jasper
    return ;
}
        request.setAttribute("mensaje", p1);
